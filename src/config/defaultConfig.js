  ...
  symbols: {
    ...
    fm9: color => (
      <symbol key="fm9" id="fm9" viewBox="0 0 32 32">
        <path d="M12 15h8v2h-8zM12 12h8v2h-8zM23 8h-14c-0.553 0-1 0.447-1 1v11c0 0.553 0.447 1 1 1h2v3l4.5-3h7.5c0.553 0 1-0.447 1-1v-11c0-0.553-0.447-1-1-1zM22 19h-6.5l-2.5 1.5v-1.5h-3v-9h12v9z" />
      </symbol>
    ),
    fm10: color => (
